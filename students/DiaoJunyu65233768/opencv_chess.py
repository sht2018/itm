...
def overlay_on_image(display_image, filtered_objects):
    ...
    for obj_index in range(len(filtered_objects)):
        ...
        cv2.line(display_image, (label_left+(label_right-label_left)/3,label_top-1), (label_left+(label_right-label_left)/3,label_bottom+1), (255,255,255), 3)
        cv2.line(display_image, (label_right-(label_right-label_left)/3,label_top-1), (label_right-(label_right-label_left)/3,label_bottom+1), (255,255,255), 3)
        cv2.line(display_image, (label_bottom+(label_top-label_bottom)/3,label_left-1), (label_bottom+(label_top-label_bottom)/3,label_right+1), (255,255,255), 3)
        cv2.line(display_image, (label_top-(label_top-label_bottom)/3,label_left-1), (label_top-(label_top-label_bottom)/3,label_right+1), (255,255,255), 3)
