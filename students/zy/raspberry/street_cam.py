...
def overlay_on_image(display_image, filtered_objects):
    ...
    for obj_index in range(len(filtered_objects)):
        ...
        if center_x < source_image_width//3:
            x=1
        elif source_image_width//3 < center_x < 2*source_image_width//3:
            x=2
        elif 2*source_image_width//3 < center_x:
            x=3
        if center_y < source_image_height//3:
            y=1
        elif source_image_height//3 < center_y < 2*source_image_height//3:
            y=2
        elif 2*source_image_height//3 < center_y:
            y=3
        boxx_number = x+y
        boxx[boxx_number]+=1
